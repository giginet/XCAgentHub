    ...
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Welcome to AgentHub")
                .font(.title.bold())
            Text("AgentHub manages the MCP servers of the coding agents that run inside Xcode. To read and update their configuration files, grant access to the folder below.")
